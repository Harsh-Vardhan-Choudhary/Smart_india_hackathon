        ...
        <>
            ...
            <img className={styles.img_eleborated} src="" slt=""></img>
                <div className={styles.content_eleborate}d>
                    ...
                    laboriosam distinctio tempore illum eveniet natus beatae inventore reprehenderit fuga et fugiat dolorem veniam repudiandae,
                    ipsum aut nemo. A nemo unde voluptate blanditiis, rerum quia neque hic saepe, perspiciatis nostrum mollitia ipsam nulla error
                    vel quo at, maxime in sed explicabo adipisci suscipit nihil aperiam consequuntur. Ea eaque beatae nam. Mollitia enim blanditiis
                    vel consequuntur exercitationem maiores sint tempora iusto provident voluptatem velit, commodi accusantium vero incidunt,
                    temporibus neque placeat non aperiam rem earum labore esse? Doloribus natus sed ea dicta quae excepturi facilis cum illum accusamus.
                    <br></br>
                    <br></br>
                </div>
            </div>
