                    ...
                    <div className={styles.user_details}>
                        ...
                        <div className={styles.input_box}>
                            ...
                            <select id="board" name="board">
                                <option value="JEE">State board</option>
                                <option value="NEET">Central Board of Secondary Education (CBSE)</option>
                                <option value="IPmat">Indian Certificate of Secondary Education (ICSE)</option>
                                <option value="CAT">National Institute of Open Schooling (NIOS)</option>
                                <option value="CLAT">Cambridge International Examinations (CIE)</option>
                        ...
                        <div className={styles.input_box}>
                            ...
                            <select id="category" name="category">
                                ...
                                <option value="IPmat">ST</option>
                                <option value="CAT">OBC</option>
                                <option value="CLAT">Other</option>
                            </select>
                        </div>
                        <br></br>
